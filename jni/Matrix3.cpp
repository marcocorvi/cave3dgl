...
Vector3
Matrix3::Transform(const Vector3& in) const
{
...
void
Matrix3::Transform(const Vector3& in, Vector3& out ) const
{
  out.m_x = (m_m[0] * in.m_x) + (m_m[1] * in.m_y) + (m_m[2] * in.m_y);
  out.m_y = (m_m[3] * in.m_x) + (m_m[4] * in.m_y) + (m_m[5] * in.m_y);
  out.m_z = (m_m[6] * in.m_x) + (m_m[7] * in.m_y) + (m_m[8] * in.m_y);
}

Vector3
Matrix3::TransformTranspose(const Vector3& in) const
{
...
void
Matrix3::RotateAroundX(const float radians)
{
...
void
Matrix3::RotateAroundY(const float radians)
{
...
void
Matrix3::RotateAroundZ(const float radians)
{
 ...
 */
// void 
// Matrix3::RotateZ( bool ccw )
// {
//   float r = ccw ? 1.0f : -1.0f;
//   float m_m0 = -r * m_m[3];
//   float m_m1 = -r * m_m[4];
//   float m_m2 = -r * m_m[5];
//   m_m[3] = r * m_m[0];
