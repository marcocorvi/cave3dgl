...
void 
Matrix4::GetRotation( Matrix3 & mat ) 
{
  mat.m_m[0] = m_m[0];
  mat.m_m[1] = m_m[1];
  mat.m_m[2] = m_m[2];
...
Vector3
Matrix4::Transform(const Vector3& in) const
{
...
void
Matrix4::Transform( const Vector3& in, Vector3 & out ) const
{
  out.m_x = (m_m[0] * in.m_x) + (m_m[1] * in.m_y) + (m_m[2] * in.m_z);
  out.m_y = (m_m[4] * in.m_x) + (m_m[5] * in.m_y) + (m_m[6] * in.m_z);
  out.m_z = (m_m[6] * in.m_x) + (m_m[7] * in.m_y) + (m_m[8] * in.m_z);
}

Vector3
Matrix4::TransformTranspose(const Vector3& in) const
{
...
Vector4
Matrix4::Multiply(const Vector4& in) const
{
...
void
Matrix4::Multiply(const Vector4& in, Vector4 & out) const
{
  out.m_x = (m_m[0] * in.m_x)  + (m_m[1] * in.m_y)  + (m_m[2] * in.m_z)  + (m_m[3] * in.m_w);
  out.m_y = (m_m[4] * in.m_x)  + (m_m[5] * in.m_y)  + (m_m[6] * in.m_z)  + (m_m[7] * in.m_w);
  out.m_z = (m_m[8] * in.m_x)  + (m_m[9] * in.m_y)  + (m_m[10] * in.m_z) + (m_m[11] * in.m_w);
  out.m_w = (m_m[12] * in.m_x) + (m_m[13] * in.m_y) + (m_m[14] * in.m_z) + (m_m[15] * in.m_w);
}

void
Matrix4::RotateAroundX(float radians)
{
...
void
Matrix4::RotateAroundY(float radians)
{
...
void
Matrix4::RotateAroundZ(float radians)
{
...
void
Matrix4::Multiply(const Matrix4& in, Matrix4& out) const
{
...
Vector4
Matrix4::GetRow(const Rows row) const
{
